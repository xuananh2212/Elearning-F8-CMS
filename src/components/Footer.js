          ...
          <div className='bg-[#181821] text-[#a9b3bb] pt-16 pb-10'>
               <section className='max-w-[1100px] w-full mx-auto flex justify-between'>
                    <section className='px-3'>
                         <div>
                              ...
                              >
                                   <Image
                                        ...
                                        alt="logo"
                                   />
                                   <span className="text-[#fff] font-black text-l">Học Lập Trình Để đi Làm</span>
                              </Link>
                         </div>
                         <p className='text-[#a9b3bb] leading-[22px] text-[14px] my-[14px] max-w-[257px]'>
                              Điện thoại:
                              <Link href="tel:0246.329.1102">
                                   0246.329.1102
                              </Link>
                              <br />
                              Email:
                         ...
                         <div>
                              <Link href={'https://www.dmca.com/Protection/Status.aspx?id=1b325c69-aeb7-4e32-8784-a0009613323a&refurl=https%3a%2f%2ffullstack.edu.vn%2f&rlo=true'}>
                                   <Image
                                        className='mt-[20px]'
                    ...
                    <section className='px-3'>
                         <div className='flex justify-center'>
                              <div>
                                   <h2 className='text-[#fff] text-[18px] leading-[16px] mt-[10px] mb-4 font-semibold'>Về F8</h2>
